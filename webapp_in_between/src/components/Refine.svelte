<script>
  ...
  import { defaultState as defaultQsState } from '../services/qs'
  ...
  const cropped = $derived(isCropped(works, wrapper))
  ...
  <div class="refine--inner">
    <h3>
      ...
      <button
        ...
        title="clear filters"
        disabled={JSON.stringify(qsState) === JSON.stringify(defaultQsState)}
        onclick={onClear}
      >
